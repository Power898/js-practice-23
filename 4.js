...
class Letter {constructor(title, text){this.title=title; this.text=text;}
...
class Picture {constructor(title, size){ this.title=title; this.size=size;}
...
class Movie {constructor(title, duration){this.title=title; this.duration=duration;}
...
readElements() { for (const element of this.elements) { if (element instanceof Letter) {

...
class BankTransfer {initiateTransfer(amount) {const calculatedAmount = this.calculateFee(amount);
...
class WalletTransfer { processTransfer(amount) {
...
class TransferAdapter {
  ...
  initiateTransfer(amount) { const calculatedAmount = this.calculateFee(amount); 
